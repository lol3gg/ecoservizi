...
export default function ServiceArea() {
  return (
    <section id="zona" className="bg-ink-soft py-12 sm:py-16 md:py-20">
          ...
          <div>
            ...
            <ul className="mt-6 flex flex-wrap gap-2">
              {comuni.map((comune) => (
                <li
                  key={comune}
                  className="border border-paper/15 bg-ink/40 px-2.5 py-1.5 font-mono text-[11px] uppercase tracking-wide text-paper min-[375px]:px-3 min-[375px]:text-xs"
                >
                  {comune}
                </li>
              ))}
              <li className="border border-dashed border-paper/25 px-2.5 py-1.5 font-mono text-[11px] uppercase tracking-wide text-steel min-[375px]:px-3 min-[375px]:text-xs">
                + su richiesta
              </li>
            </ul>
          </div>

          <div className="h-56 w-full overflow-hidden border border-paper/10 min-[375px]:h-64 sm:h-72 md:h-full md:min-h-[280px]">
            <iframe
