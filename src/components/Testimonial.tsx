export default function Testimonial() {
  return (
    <section className="bg-ink-soft py-12 sm:py-16 md:py-20">
      <div className="mx-auto max-w-3xl px-4 sm:px-6">
        <div className="ticket-edge border border-paper/10 bg-ink px-4 py-6 pt-5 sm:px-10 sm:py-10 sm:pt-7">
          <span className="font-mono text-xs uppercase tracking-widest text-rust">Recensione cliente</span>
          <blockquote className="mt-4 text-base italic leading-relaxed text-paper sm:text-lg md:text-xl">
